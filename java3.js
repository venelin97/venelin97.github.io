...
const extraQuestions = [
  {
    q: "Кой град е основан от Филип II Македонски под името Филипопол?",
    correct: "Пловдив",
    options: ["София", "Пловдив", "Варна"]
  },
  {
    q: "През коя година е признато Първото българско царство след битката при Онгъла?",
    correct: "681 г.",
    options: ["632 г.", "681 г.", "811 г."]
  },
  {
    q: "Кой български владетел превръща Велики Преслав в духовен център?",
    correct: "цар Симеон I",
    options: ["хан Крум", "княз Борис I", "цар Симеон I"]
  },
  {
    q: "Как се нарича първата българска конституция, приета през 1879 г.?",
    correct: "Търновска конституция",
    options: ["Радомирска конституция", "Търновска конституция", "Софийска конституция"]
  },
  {
    q: "На коя страна участва България в Първата световна война?",
    correct: "Централните сили",
    options: ["Антантата", "Централните сили", "СССР"]
  },
  {
    q: "Коя книга поставя началото на Българското възраждане през 1762 г.?",
    correct: "История славянобългарска",
    options: ["Рибен буквар", "История славянобългарска", "Горски пътник"]
  },
  {
    q: "Кой е основният идеолог на тайната комитетска мрежа за освобождение?",
    correct: "Васил Левски",
    options: ["Христо Ботев", "Георги Раковски", "Васил Левски"]
  },
  {
    q: "Кой мирен договор връща Южна Добруджа на България през 1940 г.?",
    correct: "Крайовска спогодба",
    options: ["Ньойски договор", "Крайовска спогодба", "Берлински договор"]
  },
  {
    q: "Какво събитие се случва на 22 септември 1908 г. във Велико Търново?",
    correct: "Обявяване на Независимостта",
    options: ["Съединението", "Обявяване на Независимостта", "Освобождението"]
  },
  {
    q: "Кой римски император е наричал днешна София „моят Рим“?",
    correct: "Константин Велики",
    options: ["Юлий Цезар", "Константин Велики", "Марк Аврелий"]
  },
  {
    q: "През кой период България е обявена за Народна република?",
    correct: "1944 – 1989 г.",
    options: ["1918 – 1944 г.", "1878 – 1908 г.", "1944 – 1989 г."]
  },
  {
    q: "Кое гръцко име носи античният Несебър?",
    correct: "Месемврия",
    options: ["Одесос", "Месемврия", "Аполония"]
  },
  {
    q: "Кой е последният владетел на Първото българско царство преди византийското завоевание?",
    correct: "цар Самуил",
    options: ["цар Петър", "цар Самуил", "цар Иван Владислав"]
  },
  {
    q: "Кога България става пълноправен член на Европейския съюз?",
    correct: "1 януари 2007 г.",
    options: ["2004 г.", "1 януари 2007 г.", "2010 г."]
  },
  {
    q: "Кой град е бил столица на Първото българско царство преди Преслав?",
    correct: "Плиска",
    options: ["Плиска", "Охрид", "Търново"]
  }
];

// ====== ЛОГИКА ЗА ИЗБОР НА 10 ОТ 15 ВЪПРОСА ======
function setupQuiz() {
    // 1. Разбъркваме всички 15 въпроса
    let shuffled = shuffleArray([...extraQuestions]);
    
    // 2. Взимаме само първите 10
    let selectedQuestions = shuffled.slice(0, 10);
    
    // 3. Разбъркваме опциите за избраните въпроси
...
// Обнови функцията shuffleQuiz, за да ползва новата логика
